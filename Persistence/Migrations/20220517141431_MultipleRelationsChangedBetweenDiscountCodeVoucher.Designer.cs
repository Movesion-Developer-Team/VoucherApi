...
namespace Persistence.Migrations
{
    ...
    [Migration("20220517141431_MultipleRelationsChangedBetweenDiscountCodeVoucher")]
    partial class MultipleRelationsChangedBetweenDiscountCodeVoucher
    {
            ...
            modelBuilder.Entity("Core.Domain.DiscountCode", b =>
                {
                    ...
                    b.Property<int?>("UnassignedDiscountCodesCollectionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UnassignedDiscountCodesCollectionId");
            ...
            modelBuilder.Entity("Core.Domain.DiscountCode", b =>
                {
                    ...
                    b.HasOne("Core.Domain.UnassignedDiscountCodeCollection", "UnassignedDiscountCodesCollection")
                        .WithMany("DiscountCodes")
                        .HasForeignKey("UnassignedDiscountCodesCollectionId");

                    b.Navigation("Discount");

                    b.Navigation("UnassignedDiscountCodesCollection");
                });
            ...
            modelBuilder.Entity("Core.Domain.Voucher", b =>
                {
                    ...
                    b.HasOne("Core.Domain.DiscountCode", "DiscountCode")
                        .WithOne("Voucher")
                        .HasForeignKey("Core.Domain.Voucher", "DiscountCodeId");
