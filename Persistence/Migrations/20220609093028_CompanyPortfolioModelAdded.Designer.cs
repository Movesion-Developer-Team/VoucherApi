...
namespace Persistence.Migrations
{
    ...
    [Migration("20220609093028_CompanyPortfolioModelAdded")]
    partial class CompanyPortfolioModelAdded
    {
            ...
            modelBuilder.Entity("Core.Domain.DiscountCode", b =>
                {
                    ...
                    b.Property<int?>("CompanyPortfolioId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.DiscountCode", b =>
                {
                    ...
                    b.HasOne("Core.Domain.CompanyPortfolio", "CompanyPortfolio")
                        .WithMany("DiscountCodes")
                        .HasForeignKey("CompanyPortfolioId");
